...
Revision ID: 614c1c3b4343
Revises: 
Create Date: 2026-07-13 20:07:36.188064
...
def upgrade() -> None:
    ...
    op.create_foreign_key(
        'fk_model_registry_active_route', 'model_registry', 'model_routing',
        ['active_route_id'], ['id'], ondelete='SET NULL',
    )
    ...
    sa.Column('cache_read_tokens', sa.Integer(), nullable=False, comment='Prompt-cache read tokens (cached prefix served from cache)'),
    sa.Column('cache_creation_tokens', sa.Integer(), nullable=False, comment='Prompt-cache write tokens (prefix written to ephemeral cache)'),
    sa.Column('latency_ms', sa.Float(), nullable=False),
