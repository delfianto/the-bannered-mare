...
class Settings(BaseSettings):
    ...
    # Discovery blacklists. Defaults are reference data in core.model_filters;
    # override wholesale via the MODEL_BLACKLIST / MODEL_VENDOR_BLACKLIST env vars
    # (JSON arrays).
    model_blacklist: list[str] = Field(default_factory=lambda: list(DEFAULT_MODEL_BLACKLIST))
