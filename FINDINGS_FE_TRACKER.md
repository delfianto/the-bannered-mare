...
- **Updated:** 2026-07-15
- **Active:** structural/DRY tier DONE (FE-M3/M4, FE-H4, FE-M1, FE-M7) + FE-M5 (correctness — stop button + regen-abort restore) done. FE-M2 deferred by decision. Remaining tiers: i18n (FE-H2 b/c + FE-H3) and low (FE-L2/L3).
- **Next up:** low FE-L2/L3 (quick); i18n FE-H2 b/c + FE-H3 (larger). (FE-M2 + ProviderModelRow deferred, documented.)
- **Progress:** 18 / 29 done (FE-C1, FE-H6, FE-H7, FE-C3, FE-H1, FE-C2, FE-M9, FE-L1, FE-L4, FE-L5, FE-M10, FE-L6, FE-L7, FE-M3, FE-M4, FE-H4, FE-M7, FE-M5 ✓; FE-L8 + FE-L-latent folded in) + FE-M1 (FE-M1/M2 half-done) + FE-H2 part-a. **Remaining:** FE-M2 (deferred), FE-L2/L3, FE-H2 b/c, FE-H3.
