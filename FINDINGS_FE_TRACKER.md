...
- **Updated:** 2026-07-15
- **Active:** structural/DRY tier DONE + FE-M5 (correctness) + FE-L2 (async confirm dialog) done. Deferred by decision: FE-M2, FE-L3, ProviderModelRow. Remaining: the i18n tier (FE-H2 b/c + FE-H3).
- **Next up:** i18n — FE-H2 b/c (SetupWizard + settings headings) + FE-H3 (fill de/es/fr/pt catalogs). The last substantive tier; FE-H3 is large + mechanical.
- **Progress:** 19 / 29 done (FE-C1, FE-H6, FE-H7, FE-C3, FE-H1, FE-C2, FE-M9, FE-L1, FE-L4, FE-L5, FE-M10, FE-L6, FE-L7, FE-M3, FE-M4, FE-H4, FE-M7, FE-M5, FE-L2 ✓; FE-L8 + FE-L-latent folded in) + FE-M1 (FE-M1/M2 half-done) + FE-H2 part-a. **Remaining:** FE-H2 b/c, FE-H3; deferred: FE-M2, FE-L3, ProviderModelRow.
