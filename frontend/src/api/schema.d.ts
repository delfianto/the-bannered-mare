...
export interface paths {
  ...
  "/api/chats/{chat_id}/messages/suggestions": {
    ...
    /**
     * Suggest Next Turn
     * @description Generate next-turn suggestions for the user.
     *
  ...
  "/api/data-bank/": {
    ...
    /**
     * Create Entry
     * @description Create a new data bank entry (indexed for RAG when enabled).
     */
  ...
  "/api/data-bank/{entry_id}": {
    ...
    /**
     * Update Entry
     * @description Update a data bank entry (re-indexed for RAG when enabled).
     */
    put: operations["update_entry_api_data_bank__entry_id__put"];
    post?: never;
    /**
     * Delete Entry
     * @description Delete a data bank entry and purge its embeddings.
     */
...
export interface components {
  schemas: {
    ...
    /**
     * SuggestionResponse
     * @description Generated suggestions. `reply` returns several; `impersonate` returns one.
     */
    SuggestionResponse: {
      /** Suggestions */
      suggestions: string[];
...
export interface operations {
  ...
  suggest_next_turn_api_chats__chat_id__messages_suggestions_post: {
    parameters: {
      query?: never;
      header?: never;
      path: {
