        ...
        <template v-else>
            ...
            <div v-else-if="searchResults.length > 0" class="mt-4 space-y-3">
              ...
              >
                <div class="mb-2 flex items-center gap-2">
                  ...
                  <span
                    class="rounded-full px-2 py-0.5 text-4xs font-medium tracking-wide"
          ...
          <div v-else class="grid grid-cols-1 gap-3 lg:grid-cols-2">
            <div
              ...
              :key="entry.id"
              class="group relative flex animate-fade-in-up flex-col app-card pb-8 transition-all hover:shadow-[0_4px_16px_var(--color-primary)/0.08]"
            ...
            >
              ...
              <div class="mb-2 flex items-start justify-between gap-2">
                ...
                <span
                  class="shrink-0 rounded-full px-2 py-0.5 text-4xs font-medium tracking-wide uppercase"
              ...
              <!-- Bottom details -->
              <div
                class="space-y-1.5 border-t border-border/30 pt-3 text-2xs text-muted-foreground"
              >
