...
<template>
  <div
    class="absolute -top-3 z-20 flex items-center gap-0.5 rounded-lg border bg-base-200 px-1 py-0.5 shadow-md transition-all duration-150"
    :class="[
  ...
  >
    <button
      ...
      class="flex size-7 items-center justify-center rounded-md text-muted-foreground transition-colors hover:bg-base-300 hover:text-foreground"
