...
Fixtures in `src/mocks/data/` mirror the backend seed data: **8 providers** (incl. OpenCode Go), **19 model families**, **34 canonical models** (registries — one, DeepSeek V4 Pro, is multi-route: OpenRouter + OpenCode Go), **20 characters** (Elder Scrolls themed, Unsplash portraits), **20 chats** with YAML conversation scenarios, **3 personas**, **3 presets**, **6 templates**, **3 fragments**, **5 data bank entries**.
