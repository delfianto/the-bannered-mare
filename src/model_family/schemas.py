...
class ModelFamilyBase(BaseModel):
    ...
    description: str | None = Field(None, description="Description of the model family")
    ...
    extra_metadata: dict[str, Any] | None = Field(
        None, description="Additional metadata about the model family"
    )
...
class ModelFamilyFilterParams(BaseModel):
    ...
    name__ilike: str | None = Field(None, description="Search family name")
    family_identifier: str | None = Field(None, description="Exact match identifier")
...
class ModelFamilyUpdate(BaseModel):
    ...
    family_identifier: str | None = Field(None, max_length=100)
