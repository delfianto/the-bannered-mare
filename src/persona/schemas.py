...
class PersonaBase(BaseModel):
    ...
    description: str | None = Field(
        None, max_length=50000, description="Persona description for RP context"
    )
    avatar: str | None = Field(None, max_length=255)
    avatar_thumbnail: str | None = Field(None, max_length=255)
...
class PersonaFilterParams(BaseModel):
    ...
    name__ilike: str | None = Field(None, description="Search persona name")
    is_default: bool | None = Field(None, description="Filter by default status")
